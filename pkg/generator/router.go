...
func GenerateRoute(basePath string, projectName string, generateFn GenerateFn) error {
	...
	logger.Debugf("GenerateRoute - create %s folder if not exist", internalFolderPath)
	...
	logger.Debug("GenerateRoute - create route input")
		...
		case "type":
			...
			default:
				return r, fmt.Errorf(
					...
					foundRoute.Package, foundRoute.Name, items[1], raiden.RouteTypeFunction, raiden.RouteTypeCustom, raiden.RouteTypeRpc,
				)
			}
		}
	}
