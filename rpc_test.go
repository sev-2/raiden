...
func TestRpcParamToGoType(t *testing.T) {
	tests := []struct {
		...
		{raiden.RpcParamDataTypeNumeric, "float64"},
		...
		{raiden.RpcParamDataTypeArrayInteger, "[]int64"},
		{raiden.RpcParamDataTypeArrayBigInt, "[]int64"},
		{raiden.RpcParamDataTypeArrayReal, "[]float32"},
		{raiden.RpcParamDataTypeArrayDoublePreci, "[]float64"},
		{raiden.RpcParamDataTypeArrayNumeric, "[]float64"},
		{raiden.RpcParamDataTypeArrayText, "[]string"},
		{raiden.RpcParamDataTypeArrayVarchar, "[]string"},
		{raiden.RpcParamDataTypeArrayVarcharAlias, "[]string"},
		{raiden.RpcParamDataTypeArrayBoolean, "[]bool"},
		{raiden.RpcParamDataTypeArrayBytea, "[][]byte"},
		{raiden.RpcParamDataTypeArrayTimestamp, "[]time.Time"},
		{raiden.RpcParamDataTypeArrayTimestampTZ, "[]time.Time"},
		{raiden.RpcParamDataTypeArrayJSON, "[]map[string]interface{}"},
		{raiden.RpcParamDataTypeArrayJSONB, "[]map[string]interface{}"},
	}
...
func TestGetValidRpcParamType(t *testing.T) {
	tests := []struct {
		...
		{"timestamp without time zone", false, raiden.RpcParamDataTypeTimestamp, false},
		{"timestampz", true, raiden.RpcParamDataTypeTimestampTZAlias, false},
		{"timestamp with time zone", false, raiden.RpcParamDataTypeTimestampTZ, false},
		{"json", false, raiden.RpcParamDataTypeJSON, false},
		{"jsonb", false, raiden.RpcParamDataTypeJSONB, false},
		{"integer[]", false, raiden.RpcParamDataTypeArrayInteger, false},
		{"bigint[]", false, raiden.RpcParamDataTypeArrayBigInt, false},
		{"real[]", false, raiden.RpcParamDataTypeArrayReal, false},
		{"double precision[]", false, raiden.RpcParamDataTypeArrayDoublePreci, false},
		{"numeric[]", false, raiden.RpcParamDataTypeArrayNumeric, false},
		{"varchar[]", false, raiden.RpcParamDataTypeArrayVarchar, false},
		{"varchar[]", true, raiden.RpcParamDataTypeArrayVarcharAlias, false},
		{"text[]", false, raiden.RpcParamDataTypeArrayText, false},
		{"boolean[]", true, raiden.RpcParamDataTypeArrayBoolean, false},
		{"bytea[]", true, raiden.RpcParamDataTypeArrayBytea, false},
		{"timestamp[]", true, raiden.RpcParamDataTypeArrayTimestampAlias, false},
		{"timestamp without time zone[]", false, raiden.RpcParamDataTypeArrayTimestamp, false},
		{"timestampz[]", true, raiden.RpcParamDataTypeArrayTimestampTZAlias, false},
		{"timestamp with time zone[]", false, raiden.RpcParamDataTypeArrayTimestampTZ, false},
		{"json[]", false, raiden.RpcParamDataTypeArrayJSON, false},
		{"jsonb[]", false, raiden.RpcParamDataTypeArrayJSONB, false},
...
func TestRpcReturnToGoType(t *testing.T) {
	tests := []struct {
		...
		{raiden.RpcReturnDataTypeNumeric, "float64"},
		...
		{raiden.RpcReturnDataTypeArrayInteger, "[]int64"},
		{raiden.RpcReturnDataTypeArrayBigInt, "[]int64"},
		{raiden.RpcReturnDataTypeArrayReal, "[]float32"},
		{raiden.RpcReturnDataTypeArrayDoublePreci, "[]float64"},
		{raiden.RpcReturnDataTypeArrayNumeric, "[]float64"},
		{raiden.RpcReturnDataTypeArrayText, "[]string"},
		{raiden.RpcReturnDataTypeArrayVarchar, "[]string"},
		{raiden.RpcReturnDataTypeArrayBoolean, "[]bool"},
		{raiden.RpcReturnDataTypeArrayBytea, "[][]byte"},
		{raiden.RpcReturnDataTypeArrayTimestamp, "[]time.Time"},
		{raiden.RpcReturnDataTypeArrayTimestampTZ, "[]time.Time"},
		{raiden.RpcReturnDataTypeArrayJSON, "[]map[string]interface{}"},
		{raiden.RpcReturnDataTypeArrayJSONB, "[]map[string]interface{}"},
	}
...
func TestGetValidRpcReturnType(t *testing.T) {
	tests := []struct {
		...
		{"timestamp without time zone", false, raiden.RpcReturnDataTypeTimestamp, false},
		{"timestampz", true, raiden.RpcReturnDataTypeTimestampTZAlias, false},
		{"timestamp with time zone", false, raiden.RpcReturnDataTypeTimestampTZ, false},
		{"integer[]", false, raiden.RpcReturnDataTypeArrayInteger, false},
		{"bigint[]", false, raiden.RpcReturnDataTypeArrayBigInt, false},
		{"real[]", false, raiden.RpcReturnDataTypeArrayReal, false},
		{"double precision[]", false, raiden.RpcReturnDataTypeArrayDoublePreci, false},
		{"numeric[]", false, raiden.RpcReturnDataTypeArrayNumeric, false},
		{"varchar[]", false, raiden.RpcReturnDataTypeArrayVarchar, false},
		{"varchar[]", true, raiden.RpcReturnDataTypeArrayVarcharAlias, false},
		{"text[]", false, raiden.RpcReturnDataTypeArrayText, false},
		{"boolean[]", true, raiden.RpcReturnDataTypeArrayBoolean, false},
		{"bytea[]", true, raiden.RpcReturnDataTypeArrayBytea, false},
		{"timestamp[]", true, raiden.RpcReturnDataTypeArrayTimestampAlias, false},
		{"timestamp without time zone[]", false, raiden.RpcReturnDataTypeArrayTimestamp, false},
		{"timestampz[]", true, raiden.RpcReturnDataTypeArrayTimestampTZAlias, false},
		{"timestamp with time zone[]", false, raiden.RpcReturnDataTypeArrayTimestampTZ, false},
		{"unsupported", false, "", true},
	}
